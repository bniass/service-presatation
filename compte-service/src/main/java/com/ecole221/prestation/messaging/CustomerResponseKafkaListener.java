...
@Component
public class CustomerResponseKafkaListener implements KafkaConsumer<CustomerCreateResponseAvroModel> {
    ...
    public CustomerResponseKafkaListener(CompteService compteService) {
    ...
    */
    @Override
    @KafkaListener(id = "${kafka-consumer-config.consumer-group-id}", topics = "${topics.customer-create-topic-response-name}")
